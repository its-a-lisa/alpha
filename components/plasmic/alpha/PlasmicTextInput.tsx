...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: XYhhZFiAgFz8/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__s4Ju)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__h8Hso)}
              role={"img"}
            />
          ),
